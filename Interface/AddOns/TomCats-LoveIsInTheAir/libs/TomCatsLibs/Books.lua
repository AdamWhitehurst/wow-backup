...
-- Testing scrollframe
    ...
    local leaveframe = CreateFrame("Button", nil, _G["TomCats-LoveIsInTheAirTourGuideFrame"], "ItemButtonTemplate, SecureActionButtonTemplate")
...
--    leaveframe:SetScript("OnEnter", function(self, button)
    ...
    local item1frame = CreateFrame("Button", nil, _G["TomCats-LoveIsInTheAirTourGuideFrame"], "ItemButtonTemplate, SecureActionButtonTemplate")
    ...
    local item3frame = CreateFrame("Button", nil, _G["TomCats-LoveIsInTheAirTourGuideFrame"], "ItemButtonTemplate, SecureActionButtonTemplate")
    ...
    local item2frame = CreateFrame("Button", nil, _G["TomCats-LoveIsInTheAirTourGuideFrame"], "ItemButtonTemplate, SecureActionButtonTemplate")
    ...
    local item4frame = CreateFrame("Button", nil, _G["TomCats-LoveIsInTheAirTourGuideFrame"], "ItemButtonTemplate, SecureActionButtonTemplate")
    ...
    local item5frame = CreateFrame("Button", nil, _G["TomCats-LoveIsInTheAirTourGuideFrame"], "ItemButtonTemplate, SecureActionButtonTemplate")
