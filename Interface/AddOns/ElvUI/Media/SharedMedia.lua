...
AddMedia('font','Sriracha.ttf',		'Continuum Medium')
AddMedia('font','Sriracha.ttf',			'Die Die Die!')
AddMedia('font','Sriracha.ttf',			'PT Sans Narrow', nil, westAndRU)
AddMedia('font','Sriracha.ttf',			'Sriracha', nil, westAndRU)
AddMedia('font','Sriracha.ttf',			true, nil, westAndRU)
AddMedia('font','Sriracha.ttf',				true, nil, westAndRU)
AddMedia('font','Sriracha.ttf',				'Expressway', nil, westAndRU)
AddMedia('font','Sriracha.ttf',				'Homespun', nil, westAndRU)
AddMedia('font','Sriracha.ttf',				'Invisible', nil, westAndRU)
